    ...
    [
        ...
        [
            ...
            [
                [
                    ...
                    'url' => 'datakomponennilai',
                    'icon' => '',
                    'sub' => []
                ],
                [
                    //'role' => 'user',
                    'name' => 'Range Penilaian',
                    'url' => 'databobotnilai',
                    'icon' => '',
                    'sub' => []
                ],
                [
                    ...
                    //'role' => 'user',
                    'name' => 'Bobot Komponen Penilaian',
                    'url' => 'databobotkomponennilai',
                    'icon' => '',
                    'sub' => []
                ],
                [
        ...
        [
            ...
            [
                ...
                [
                    //'role' => 'user',
                    'name' => 'Paket Pembayaran Siswa',
                    'url' => 'datapaket/paketpembayaran',
                    'icon' => '',
                    'sub' => []
                ],
                [
