...
class DatapembayaransppController extends Controller
{
    ...
    public function getIndex(Request $request) {
        ...
        //                 $btn = '<a href="/datapembayaranspp/create/'.$row->nisn.'"><i class="fas fa-edit" style="font-size:15px;color:#009ef7;"></i></a>9
        //                 &nbsp;&nbsp;
    ...
    public function getShow($id) {
        $rincian = DB::table('v_tblvalidasispp')->where('nisn', base64_decode($id))->get();
        $siswa = DB::table('v_sppsiswa')->where('nisn', base64_decode($id))->get();
