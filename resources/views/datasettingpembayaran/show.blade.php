...
<div class="me-4">
    <!--begin::Menu-->
        <a href="/datasettingpembayaran" class="btn btn-sm btn-flex btn-info fw-bolder">Kembali ke {{ $testVariable3 }}</a>
</div>
<a href="/datasettingpembayaran/create" class="btn btn-sm btn-primary">Edit Setting Pembayaran Siswa</a>
@endsection
