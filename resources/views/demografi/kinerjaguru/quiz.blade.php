        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body p-0">
                        <!--begin::Header-->
                        <div class="px-9 pt-7 card-rounded h-325px w-100 bg-danger">
                            <!--begin::Heading-->
                            <div class="d-flex flex-stack">
                                <h3 class="m-0 text-white fw-bolder fs-3"><i class="fas fa-chart-area text-white" style="font-size: 18px"></i>&nbsp;Statistik Pemberian Ujian Online</h3>
                            </div>
                            <!--end::Heading-->
                            <!--begin::Balance-->
                            ...
                            <!--begin::Balance-->
                            <div class="d-flex text-center flex-column text-white pt-4">
                                <span class="fw-bolder fs-2x pt-1">3.021</span>
                                <span class="fw-bold fs-7">Ujian Terupload</span>
                            </div>
                            <!--end::Balance-->
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1 text-center" style="margin-top: -100px">
                            <h3 style="font-weight: 400">Rata-Rata Jumlah Ujian Online Terupload di Setiap Kelas</h3>
            ...
            <div class="col-md-6">
                <div class="card card-custom gutter-b position-relative mb-3">
                    <div class="card-body">
                        <h3 class="m-0 fw-bolder fs-3 mb-3"><i class="fas fa-user" style="font-size: 18px; color: #000"></i>&nbsp;Data Pemberian Quiz/Ujian Online</h3>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column w-100" style="padding-right: 15px;">
                                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                                        <span class="text-muted mr-2 font-size-sm font-weight-bold">9 Ujian Online</span>
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column w-100" style="padding-right: 15px;">
                                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                                        <span class="text-muted mr-2 font-size-sm font-weight-bold">8 Ujian Online</span>
                                                    </div>
                                                    <div class="progress progress-xs w-100">
                                                        <div class="progress-bar bg-success" role="progressbar"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column w-100" style="padding-right: 15px;">
                                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                                        <span class="text-muted mr-2 font-size-sm font-weight-bold">7 Ujian Online</span>
                                                    </div>
                                                    <div class="progress progress-xs w-100">
                                                        <div class="progress-bar bg-success" role="progressbar"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column w-100" style="padding-right: 15px;">
                                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                                        <span class="text-muted mr-2 font-size-sm font-weight-bold">6 Ujian Online</span>
                                                    </div>
                                                    <div class="progress progress-xs w-100">
                                                        <div class="progress-bar bg-success" role="progressbar"
