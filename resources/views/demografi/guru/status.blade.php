          ...
          <div class="card-body" style="position: relative;">
              ...
              <div class="row justify-content-center">
                <div class="col-md-4 cards">
                  ...
                  <p>Kurun Waktu < 1 Tahun ({{$kurangSetahunPensiun . ' Guru'}})</p>
                  <div class="contain">
                ...
                <div class="col-md-4 cards">
                  <h5>Tabel Guru Menuju Pensiun</h5>
                  <p>Kurun Waktu 1-5 Tahun ({{$satuSampaiLimaPensiun . ' Guru'}})</p>
                  <div class="contain">
                ...
                <div class="col-md-4 cards">
                  <h5>Tabel Guru Menuju Pensiun</h5>
                  <p>Kurun Waktu 5-10 Tahun ({{$limaSampaiSepuluhPensiun . ' Guru'}})</p>
                  <div class="contain">
                ...
                <div class="col-md-4 cards">
                  <h5>Tabel Guru Menuju Pensiun</h5>
                  <p>Kurun Waktu > 10 Tahun ({{$lebihSepuluhPensiun . ' Guru'}})</p>
                  <div class="contain">
