        ...
        <div class="row mt-3">
            <div class="col-md-4">
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Jumlah Pegawai berdasarkan Jenis Kelamin per Jenjang Pendidikan</h3>
                        </div>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Jumlah Pegawai berdasarkan Jenis Kelamin per Status Kepegawaian</h3>
                        </div>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Jumlah Pegawai berdasarkan Jenis Kelamin per Status Marital</h3>
                        </div>
                    </div>
                    <div class="card-body">
