...
<!--begin::Button-->
<a href="/dataruangkelas/create" class="btn btn-sm btn-primary">Tambah {{$testVariable}}</a>
@endsection
                        ...
                        <table class="table table-striped table-bordered data-table" id="tabeldata">
                            ...
                            <tbody>
                                ...
                                <tr style="height: 40px">
                                    ...
                                    <td>@if($data->jenis_ruangan == 'ruang_kelas') Ruang Kelas @elseif($data->jenis_ruangan == 'lab') Laboratorium @endif</td>
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                              <a href="/dataruangkelas/edit/{{ base64_encode($data->idruang) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                              <a href="javascript:;" onclick="konfirmasi({{$data->idruang}})" class="menu-link px-3">Hapus</a>
                                            </div>
                                            <!--end::Menu item-->
