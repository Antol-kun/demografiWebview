                                    ...
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                              <a href="/datapembayaranspp/create/{{ base64_encode($data->nisn) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                              <a href="/datapembayaranspp/show/{{ base64_encode($data->nisn) }}" class="menu-link px-3">Detail</a>
                                            </div>
                                            <!--end::Menu item-->
