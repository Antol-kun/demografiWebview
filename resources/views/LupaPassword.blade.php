			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(https://preview.keenthemes.com/metronic8/demo1/assets/media/illustrations/sketchy-1/14.png">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="post" action="{{route('sendemail')}}">
                        {{ csrf_field() }}
							<!--begin::Heading-->
							<div class="text-center mb-10">
								...
								<!--end::Title-->
								<!--begin::Link-->
								<div class="text-gray-400 fw-bold fs-4">Password Baru Akan Dikirim Ke Email Anda yang Terdaftar</div>
								<!--end::Link-->
							</div>
							<!--begin::Heading-->
							<!--begin::Input group-->
							<div class="fv-row mb-10">
								<!--begin::Label-->
								<label class="form-label fs-6 fw-bolder text-dark">Masukan NIP/NISN</label>
								<!--end::Label-->
								<!--begin::Input-->
...
{{--									<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>--}}
                                ...
                                <a href="/" class="btn btn-lg btn-secondary w-100 mb-5">
