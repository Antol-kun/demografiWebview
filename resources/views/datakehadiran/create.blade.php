    ...
    <div id="kt_content_container" class="container">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <!--end::Notice-->
                <!--begin::Input group-->
                <form name="kehadiraninput" id="kehadiraninput" action="{{ route('kehadiran.store') }}" enctype="multipart/form-data" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset>
        ...
        <script>
            ...
            $('#saveBtn').click(function(e){
                ...
                $.ajax({
                    ...
                    data: new FormData($('#kehadiraninput')[0]),
                    url: "/datakehadiran/store",
                    type: "POST",
                    processData: false,
                    contentType: false,
                    dataType: 'json',
                    success: function(data){
                        ...
                        if(data.success == true){
                            Swal.fire("Berhasil", "Data Kehadiran berhasil ditambahkan !", "success");

                            $('#kehadiraninput').trigger('reset');
