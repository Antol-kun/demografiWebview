...
<a href="{{ url('datakomponennilai') }}" class="btn btn-sm btn-primary">Kembali ke {{$testVariable}}</a>
@endsection
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <form name="kelasinput" id="kelasinput" method="post">
                	@foreach($datakomp as $data)
                <div class="row mb-5">
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <input type="hidden" name="id" value="{{$data->idkompnilai}}"/>
                        <label class="required fs-5 fw-bold mb-2">Nama Komponen Penilaian</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" id="nama" name="nama" value="{{$data->nama_komponen}}" />
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                </div>
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                  ...
                  success: function (data) {
                      ...
                      location.href = "/datakomponennilai/";
                      console.log(data);
                  },
                  error: function (data) {
