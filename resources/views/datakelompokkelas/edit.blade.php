...
<a href="/datakelompokkelas" class="btn btn-sm btn-primary">Kembali ke {{$testVariable}}</a>
@endsection
    ...
    <div id="kt_content_container" class="container">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-5">
                    <!--begin::Col-->
                    <input type="hidden" name="id_kelompok" value="{{$data->idkelompokkls}}"/>
                       <div class="col-md-6 fv-row">
                            ...
                            <option value="{{$data->tingkat_kelas}}" selected>{{$data->tingkat_kelas}}</option>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <select name="jurusan" class="form-select form-select-solid">
                            ...
                            <option value="{{$data->idjurusan}}" selected>{{$data->singkatan}} - ({{$data->nama_jurusan}})</option>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--end::Input-->
                        <!-- <input type="text" class="form-control form-control-solid" placeholder="" name="nama" value="{{$data->nama_kelompok}}"/> -->
                        <select name="nama" class="form-select form-select-solid">
                            <option value="">Pilih Nama Kelompok Kelas...</option>
                            <option value="{{$data->nama_kelompok}}" selected>{{$data->nama_kelompok}}</option>
                            @for($a=1; $a<10; $a++)
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                  ...
                  success: function (data) {
                      ...
                      location.href = "/datakelompokkelas";
                      console.log(data);
                  },
                  error: function (data) {
