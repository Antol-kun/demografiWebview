        ...
        $(function () {
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                  ...
                  url: "/datakelompokkelas/store",
                  type: "POST",
                  dataType: 'json',
                  success: function (data) {
                    if(data.message == 'match'){
                        Swal.fire("Perhatian !", "Data kelompok kelas berikut sudah terdaftar !", "warning");
                        document.getElementById("saveBtn").disabled = false;
                        $('#saveBtn').html('Simpan');
                    }else{
                        Swal.fire("Berhasil", "Data kelompok kelas berhasil ditambahkan", "success");
