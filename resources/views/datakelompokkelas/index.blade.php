...
<!--begin::Button-->
<a href="/datakelompokkelas/create" class="btn btn-sm btn-primary">Tambah {{$testVariable}}</a>
@endsection
                                     ...
                                     <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                              <a href="/datakelompokkelas/edit/{{ base64_encode($data->idkelompokkls) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                              <a href="javascript:;" onclick="konfirmasi({{$data->idkelompokkls}})" class="menu-link px-3">Hapus</a>
                                            </div>
                                            <!--end::Menu item-->
...
<script>
        ...
        function konfirmasi(id){
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                      url: "/datakelompokkelas/hapus/"+id,
                      type: "GET",
                      dataType: 'json',
