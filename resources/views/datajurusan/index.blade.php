...
<!--begin::Button-->
<a href="/datajurusan/create" class="btn btn-sm btn-primary">Tambah {{$testVariable}}</a>
@endsection
                        ...
                        <table class="table table-striped table-bordered data-table" id="tabeldata">
                            ...
                            <tbody>
                                ...
                                <tr style="height: 40px">
                                    ...
                                    <td>@if($data->Nama == NULL) --- @else {{$data->Nama}} @endif</td>
                                    <td>@if($data->tahunakademik == NULL || $data->semester == NULL) ---/--- @else {{$data->tahunakademik}}/{{$data->semester}} @endif</td>
                                    <td>@if($data->status_jurusan == 'Y') Aktif @else Tidak Aktif @endif</td>
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                              <a href="/datajurusan/edit/{{ base64_encode($data->idjurusan) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                              <a href="javascript:;" onclick="konfirmasi({{$data->idjurusan}})" class="menu-link px-3">Hapus</a>
                                            </div>
                                            <!--end::Menu item-->
