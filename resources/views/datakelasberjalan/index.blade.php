...
<!--begin::Button-->
<a href="/datakelasberjalan/create" class="btn btn-sm btn-primary">Tambah {{$testVariable}}</a>
@endsection
                                    ...
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                              <a href="/datakelasberjalan/edit/{{ base64_encode($data->idkelasberjalan) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
...
<script>
        ...
        function konfirmasi(id){
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                      url: "/datakelasberjalan/hapus/"+id,
                      type: "GET",
                      dataType: 'json',
