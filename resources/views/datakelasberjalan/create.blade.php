                        ...
                        <!--begin::Input-->
                         <select name="rombel" class="form-select form-select-solid">
                          ...
                          @foreach($kelompok as $data)
                            <option value="{{$data->idkelompokkls}}">{{$data->kode_kelompok}} - ({{$data->nama_jurusan}})</option>
                          @endforeach
                        </select>
                        <!--end::Input-->
                    </div>
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                  ...
                  success: function (data) {
                    ...
                    Swal.fire("Berhasil", "Data kelompok kelas berjalan berhasil ditambahkan", "success");
