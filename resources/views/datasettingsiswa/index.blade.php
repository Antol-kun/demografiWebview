...
<!--begin::Button-->
<a href="/datasettingsiswa/create" class="btn btn-sm btn-primary">Tambah {{$testVariable}}</a>
@endsection
                        ...
                        <table class="table table-striped table-bordered data-table" id="tabeldata">
                            ...
                            <tbody>
                                ...
                                <tr style="height: 40px">
                                    ...
                                    <td><u>{{$data->Nama}}</u><br/>NIP : {{$data->Nip}}</td>
                                    <td>{{$data->jmlhsiswa}} Siswa</td>
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                              <a href="/datasettingsiswa/show/{{ base64_encode($data->kode_kelompok) }}/{{base64_encode($data->tahunakademik)}}/{{base64_encode($data->semester)}}" class="menu-link px-3">Detail</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                              <a href="javascript:;" onclick="konfirmasi({{$data->idkelasberjalan}})" class="menu-link px-3">Hapus</a>
                                            </div>
                                            <!--end::Menu item-->
...
<script>
    ...
    @if(Session::get('pesan') == 'match1')
        Swal.fire("Gagal", "Kelompok Kelas sudah ditambahkan !" , "error");
    @endif

function konfirmasi(kls){
            Swal.fire({
                title: "Perhatian !",
                ...
                if (result.value) {
                    $.ajax({
                      url: "/datasettingsiswa/hapus/"+kls,
                      type: "GET",
                      dataType: 'json',
