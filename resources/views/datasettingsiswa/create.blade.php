            ...
            <div class="card-body pt-0">
                ...
                <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="tabeldata" role="grid">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0" role="row">
                                <th class="w-10px pe-2 sorting_disabled" rowspan="1" colspan="1" aria-label="" style="width: 5.25px;">
                                    <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                        <input class="form-check-input" type="checkbox" checked="checked" data-kt-check="true" data-kt-check-target="#tabeldata .form-check-input" value="1">
                                    </div>
                                </th>
                            ...
                            <tr class="odd">
                                <td><div class="form-check form-check-sm form-check-custom form-check-solid"><input class="form-check-input" type="checkbox" checked="checked" name="id[]" value="{{$siswa->nisn}}"></div></td>
