...
<html lang="en">
    <!--begin::Head-->
    <head>
        <title>Login  - {{$sekolah->nama_sekolah}}</title>
        ...
        <link rel="shortcut icon" href="http://edsy.ubl.ac.id/logo/{{$sekolah->logo}}" />
        <!--begin::Fonts-->
            ...
            <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(https://preview.keenthemes.com/metronic8/demo1/assets/media/illustrations/sketchy-1/14.png">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                    ...
                    <a href="{{url('/')}}" class="mb-12">
                        <img alt="Logo" src="http://edsy.ubl.ac.id/logo/{{$sekolah->logo}}" class="logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Wrapper-->
                    <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                        <!--begin::Form-->
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="post" action="/authen/postlogin">
                        {{ csrf_field() }}
                            <!--begin::Heading-->
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="d-flex flex-stack mb-2">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Link-->
                                    <a href="{{route('helpdesk')}}" class="link-primary fs-6 fw-bolder">Lupa Password ?</a>
                                    <!--end::Link-->
                                </div>
                                <!--end::Wrapper-->
                                <!--begin::Input-->
