    ...
    <div id="kt_content_container" class="container">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                Setting Paket Pembayaran Siswa
            </div>
            <!--begin::Card title-->
            <!--begin::Card toolbar-->
        ...
        <div class="card-body pt-0">
            ...
            <!--end::Notice-->
            <!--begin::Input group-->
            <form method="post" action="{{route('simpanpaketsiswa')}}">
                @csrf
                <div class="row mb-5">
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <select required id="showkelas" onchange="showSiswa(event)" name="showkelas" class="form-select form-select-solid">
                            <option value="" disabled selected>--</option>
                            @foreach($kelas as $data)
                                <option>{{$data->tingkat_kelas.' '.$data->singkatan.'-'.$data->nama_kelompok}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <label class="required fs-5 fw-bold mb-2">Pilih Paket</label>
                        <!--end::Label-->
                        <select required id="idpaket"  name="idpaket" class="form-select form-select-solid">
                            <option value="" disabled selected>--</option>
...
<script>
      ...
      //       processing: true,
      //       serverSide: true,
      //       ajax: "/datasettingpembayaran/index",
      //       columns: [
    ...
    <script>
    function showSiswa(evt) {
        var kelas = evt.target.value
        var id = kelas.replace(" ", "-");

        if(kelas != ''){
            $('#loadsiswa').load('/loadsiswa/'+id)
        }
