...
<!--begin::Button-->
<a href="/datasettingjadwal/create" class="btn btn-sm btn-primary">Tambah {{$testVariable}}</a>
@endsection
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr style="height: 40px">
                                    ...
                                    <td>{{$data->Nama}}</td>
                                    <td>{{$data->hari}}<br/><i class='fas fa-clock'></i> {{$data->jam_mulai}} - {{$data->jam_selesai}}</td>
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                              <a href="/datasettingjadwal/edit/{{ base64_encode($data->idsetjadwal) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                              <a href="javascript:;" onclick="konfirmasi({{$data->idsetjadwal}})" class="menu-link px-3">Hapus</a>
                                            </div>
                                            <!--end::Menu item-->
...
<script>
        ...
        function konfirmasi(id){
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                      url: "/datasettingjadwal/hapus/"+id,
                      type: "GET",
                      dataType: 'json',
