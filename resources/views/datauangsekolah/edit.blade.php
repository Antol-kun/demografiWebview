...
<a href="/datauangsekolah" class="btn btn-sm btn-primary">Kembali ke {{$testVariable}}</a>
@endsection
            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <input type="hidden" name="id" value="{{$data->idkomponen}}"/>
                        <label class="required fs-5 fw-bold mb-2">Komponen Biaya</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="Nama Komponen Biaya" name="komponen" value="{{$data->nama_komponen}}"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        <!--end::Label-->
                        <label class="required fs-5 fw-bold mb-2">Besaran Biaya</label>
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="Besaran Biaya" name="besaran" value="Rp.{{ number_format($data->besaran_biaya) }}" id="rupiah"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                </div>
