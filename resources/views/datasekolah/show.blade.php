                    ...
                    <!--begin::Col-->
                        <div class="col-xl-9">
                            ...
                            <div class="card-header border-0">
                                <h3 class="card-title fw-bolder text-dark">Informasi Sekolah</h3>
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                                    ...
                                    <div class="col-xl-3">
                                        ...
                                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                                            ...
                                            <div class="card-body py-3">
                                                <img src="{{ asset('logo/'.$sekolah->logo) }}" class="img-thumbnail" alt="Logo Sekolah" width="204" height="15a">
                                            </div>
                                            <!--begin::Body-->
                                        </div>
                                        <!--end::Tables Widget 9-->
