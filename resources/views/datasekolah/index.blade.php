                        ...
                        <table id="tabeldata" class="table table-striped table-bordered data-table">
                            ...
                            <tbody>
                                ...
                                <tr style="height: 40px">
                                    ...
                                    <td>{{$data->kab_kota}}</td>
                                    <td>{{$data->kec}}</td>
                                    <td><a href="/datasekolah/show/{{base64_encode($data->idsekolah)}}"><i class="fas fa-eye" style="font-size:15px;color:green;"></i></a>
                                       &nbsp;&nbsp;<a href="/datasekolah/edit/{{base64_encode($data->npsn)}}"><i class="fas fa-edit" style="font-size:15px;color:#009ef7;"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
