...
<a href="/datasekolah" class="btn btn-sm btn-primary">Kembali ke {{$testVariable}}</a>
@endsection
    ...
    <div id="kt_content_container" class="container">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <form name="kelasinput" id="kelasinput" method="post" enctype="multipart/form-data">
                <div class="row mb-5">
                    <!--begin::Col-->
                ...
                <div class="row g-9 mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <label class="fs-5 fw-bold mb-2">Web Sekolah</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                ...
                <div class="row g-9 mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <label class="fs-5 fw-bold mb-2">Email Sekolah</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-solid" placeholder="" name="email_sekolah" id="email_sekolah" value="{{$sekolah->emailsekolah}}" autocomplete="off"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <label class="fs-5 fw-bold mb-2">Logo Sekolah</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="file" class="form-control form-control-solid" placeholder="" name="logosekolah" id="logosekolah" onchange="readURL(this);"/><br/>
                        <img id="blah" src="{{ asset('logo/'.$sekolah->logo) }}" class="img-thumbnail" alt="Logo Sekolah" width="204" height="136"> 
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->                    
                </div>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <label class="fs-5 fw-bold mb-2">Luas Tanah (M<sup>2</sup>)</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                    ...
                    <div class="col-md-6 fv-row">
                        <!--end::Label-->
                        <label class="fs-5 fw-bold mb-2">Jumlah Ruang Kelas</label>
                        <!--end::Label-->
                        <!--end::Input-->
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <label class="fs-5 fw-bold mb-2">Jumlah Lab</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                    ...
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        <label class="fs-5 fw-bold mb-2">Jumlah Perpus</label>
