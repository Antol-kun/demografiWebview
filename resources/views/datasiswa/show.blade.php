                ...
                <div class="py-5">
                    <div class="rounded border p-10">
                        <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                            <li class="nav-item">
                                <a class="nav-link active" data-bs-toggle="tab" href="#kt_tab_pane_4"><i class="fas fa-user"></i> Data Diri Siswa</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_7"><i class="fas fa-file-pdf"></i> Raport Siswa</a>
                            </li>
                        </ul>
                    ...
                    <tbody>
                        ...
                        <div class="tab-pane fade" id="kt_tab_pane_7" role="tabpanel">
                            ...
                            <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                <embed type="application/pdf" src="http://guruedsy.ubl.ac.id/theme2/gambar/raport.pdf" width="100%" height="870px">
                            </div>
                            </div>
                            <!--end::Table-->
