    ...
    <div id="kt_content_container" class="container">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <!--end::Notice-->
                <!--begin::Input group-->
                <form name="kelasinput" id="kelasinput" action="/datasiswa/update" enctype="multipart/form-data" method="post">
                    {{ csrf_field() }}
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="number" class="form-control form-control-solid" placeholder="" name="nis" id="nis" required autocomplete="off" value="{{$siswa->nis}}"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="number" class="form-control form-control-solid" placeholder="" name="nisn" id="nisn" required autocomplete="off" value="{{$siswa->nisn}}"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                </div>
				<div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="number" class="form-control form-control-solid" placeholder="" name="nik" id="nik" autocomplete="off" value="{{$siswa->nik}}" required/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="number" class="form-control form-control-solid" placeholder="" name="kk" required id="kk" autocomplete="off" value="{{$siswa->kk}}"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                </div>
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="nama" id="nama" required autocomplete="off" value="{{$siswa->nama_siswa}}"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        <!--end::Label-->
                        <label class="fs-5 fw-bold mb-2">Email Wali Siswa</label>
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="email" required class="form-control form-control-solid" placeholder="" name="emailwali" value="{{$siswa->email_wali}}" required id="emailwali" autocomplete="off"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="number" class="form-control form-control-solid" placeholder="" name="no_telp" id="no_telp" value="{{$siswa->no_telp}}" required autocomplete="off"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->  
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="number" class="form-control form-control-solid" placeholder="" name="no_telp_wali" id="no_telp_wali" value="{{$siswa->no_telp_wali}}" required autocomplete="off"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->   
                </div>
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="kerja_ayah" id="kerja_ayah" value="{{$siswa->kerja_ayah}}" autocomplete="off"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="kerja_ibu" id="kerja_ibu" value="{{$siswa->kerja_ibu}}" autocomplete="off"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                </div>
                <div class="row mb-5">                    
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="number" class="form-control form-control-solid" placeholder="" name="anak_ke" id="anak_ke" value="{{$siswa->anak_ke}}" autocomplete="off"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <select name="tahun_masuk" id="tahun_masuk" class="form-select form-select-solid" required>
                               ...
                               <option value="{{$siswa->tahunmasuk}}" selected>{{ $siswa->tahunmasuk }}</option>
                               {{ $thn = date('Y') }}
                               @for($a=2015; $a<=$thn; $a++)
                ...
                <div class="row mb-5">                    
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <select name="tingkat" class="form-select form-select-solid" required>
                            ...
                            <option value="{{$siswa->tingkatkelas}}" selected>{{$siswa->tingkatkelas}}</option>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <select name="status_siswa" id="status_siswa" class="form-select form-select-solid" required>
                            ...
                            <option value="{{$siswa->statussiswa}}" selected>{{$siswa->statussiswa}}</option>
                ...
                <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        ...
                        <img id="blah" src="@if($siswa->foto == null) {{ asset('pasfoto/siswa/no-image.png') }} @else {{ asset('pasfoto/siswa/'.$siswa->foto) }} @endif" class="img-thumbnail" alt="Pasfoto" width="204" height="136"> 
                        <!--end::Input-->
                    </div>
				</div>
                <fieldset>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="nopes" id="nopes" value="{{$siswa->ijazah_nopes}}" autocomplete="off"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->  
                </div>
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="no_shun" id="no_shun" value="{{$siswa->ijazah_no_shun}}" autocomplete="off"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
            ...
            <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="date" class="form-control form-control-solid" placeholder="" name="tgl_masuk" id="tgl_masuk" value="{{$siswa->tgl_masuk}}" autocomplete="off"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-5">                    
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="date" class="form-control form-control-solid" placeholder="" name="tgl_keluar" id="tgl_keluar" value="{{$siswa->tgl_keluar}}" autocomplete="off"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->  
                </div>
            ...
            <div class="card-footer text-end">
                <button class="btn w-100 w-sm-auto btn-primary" type="submit" id="saveBtn">
