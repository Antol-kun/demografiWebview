@php
      ...
      $profil = DB::table('tabelguru')->where('Nip', Auth::user()->username )->first();

     if(empty($profil)):
        $profilfoto = 'no-image.png';
     else:
        $profilfoto = $profil->paspoto;
     endif;
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                            <img src="{{asset('pasfoto/guru/'.$profilfoto)}}" alt="foto user" />
                        </div>
                        <!--begin::Menu-->
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Foto User" src="{{asset('pasfoto/guru/'.$profilfoto)}}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                                        <div class="fw-bolder d-flex align-items-center fs-5">{{Session::get('nama')}}</div>
                                        <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{Session::get('level')}}</a>
                                    </div>
                                    <!--end::Username-->
                                </div>
                            </div>
                            ...
                            <div class="menu-item px-5">
                                ...
                                <a href="/authen/profil_admin/{{ base64_encode(Session::get('username')) }}" class="menu-link px-5">My Profile</a>
                                @else
                                <a href="/authen/profil_staff/{{ base64_encode(Session::get('username')) }}" class="menu-link px-5">My Profile</a>
                                @endif
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                <a href="/authen/logout/" class="menu-link px-5">Sign Out</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
