    ...
    <div id="kt_content_container" class="container">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <div class="d-flex flex-stack flex-grow-1">
                        ...
                        <div class="fw-bold">
                            ...
                            <div class="fs-6 text-gray-600">Pengguna agar memperhatikan seluruh <b
                                    class="text-danger">input/isian</b> yang disediakan!</div>
                        </div>
                        <!--end::Content-->
                    </div>
                    <!--end::Wrapper-->
                ...
                <!--end::Notice-->
                <!--begin::Input group-->
                <form method="post" id="ubahpass">
                    <div class="row mb-5">
                        <!--begin::Col-->
                        <div class="col-md-6 fv-row">
                            <!--end::Label-->
                            <label class="required fs-5 fw-bold mb-2">Password Baru</label>
                            <font size="1pt">(Password di generate oleh sistem : 12345678)</font>
                            <!--end::Label-->
                            <!--end::Input-->
                            <input type="password" required class="form-control form-control-solid" placeholder=""
    ...
    $.ajaxSetup({
        ...
        $("#saveBtn").click(function(e){
            ...
            $.ajax({
                ...
                url: "/datauser/postubahpass/{{ $duser->id }}",
                type: "POST",
                dataType: 'json',
                success: function (data) {  
                    ...
                    if(data.message == 'Berhasil'){
                        ...
                        $('#ubahpass').trigger("reset");
                        document.getElementById("saveBtn").disabled = false;
                        $('#saveBtn').html('Simpan');
                        location.reload();
                        Swal.fire("Gagal", "Password Gagal Direset !", "warning");
                      }
                },
                error: function (err) {
                    ...
                    $('#saveBtn').html('Simpan');
                    document.getElementById("saveBtn").disabled = false;
                    Swal.fire("Gagal", "Data gagal diubah !"+err, "error");
                }
            });
        });
</script>
