            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" required class="form-control form-control-solid" placeholder="" name="username" id="username" readonly />
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="text" required class="form-control form-control-solid" placeholder="" name="nama" id="nama" readonly />
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="email" required class="form-control form-control-solid" placeholder="" name="email" id="email" readonly />
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="password" required class="form-control form-control-solid" placeholder="" name="password" id="password" readonly />
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
