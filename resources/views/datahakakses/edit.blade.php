...
<a href="{{ url('datahakakses') }}" class="btn btn-sm btn-primary">Kembali ke {{$testVariable}}</a>
@endsection
            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 fv-row">
                        <!--begin::Label-->
                        <input type="hidden" name="id" value="{{$data->idhakakses}}"/>
                        <label class="required fs-5 fw-bold mb-2">Nama Role</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="nama" value="{{$data->nama_akses}}"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-md-6 fv-row">
                        <!--end::Label-->
                        <label class="required fs-5 fw-bold mb-2">Keterangan Role</label>
                        <!--end::Label-->
                        <!--end::Input-->
                        <input type="text" class="form-control form-control-solid" placeholder="" name="keterangan" value="{{$data->keterangan_akses}}"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Col-->
                </div>
